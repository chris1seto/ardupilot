...
bool AP_Arming_Plane::pre_arm_checks(bool display_failure)
{
    ...
    if (plane.channel_throttle->get_reverse() && 
        Plane::RcFailsafe(plane.g.rc_failsafe_enabled.get()) != Plane::RcFailsafe::Disabled &&
...
bool AP_Arming_Plane::rc_received_if_enabled_check(bool display_failure)
{
    ...
    if ((Plane::RcFailsafe(plane.g.rc_failsafe_enabled.get()) == Plane::RcFailsafe::Enabled) && 
